import { R as ROUTE_TYPE_HEADER, v as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, w as ActionNotFoundError, x as s, y as clientAddressSymbol, z as LocalsNotAnObject, B as FailedToFindPageMapSSR, C as REROUTABLE_STATUS_CODES, G as responseSentSymbol, H as nodeRequestAbortControllerCleanupSymbol, J as getAugmentedNamespace, K as commonjsGlobal } from './astro/server_D0FKrmaD.mjs';
import 'clsx';
import { D as DEFAULT_404_ROUTE, d as default404Instance, e as ensure404Route } from './astro-designed-error-pages_BvcEY9U8.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_D2RHSa-B.mjs';
