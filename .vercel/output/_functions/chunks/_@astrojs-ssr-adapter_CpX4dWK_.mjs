import { R as ROUTE_TYPE_HEADER, v as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, w as ActionNotFoundError, x as s, y as clientAddressSymbol, z as LocalsNotAnObject, B as REROUTABLE_STATUS_CODES, C as responseSentSymbol, G as nodeRequestAbortControllerCleanupSymbol, H as getAugmentedNamespace, J as commonjsGlobal } from './astro/server_CJfq-tyP.mjs';
import 'clsx';
import { D as DEFAULT_404_ROUTE, d as default404Instance, e as ensure404Route } from './astro-designed-error-pages_B5XrIqMF.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_CSrAvvhB.mjs';
