import { e as createComponent, f as createAstro, k as renderComponent, r as renderTemplate, m as maybeRenderHead } from './astro/server_CJfq-tyP.mjs';
import { $ as $$Layout } from './Layout_BnVrAAn4.mjs';
...
import { a as useTranslation, u as useLanguage, L as LanguageProvider } from './i18n_Bd6mPn--.mjs';
import { g as getLegalCondition, a as getAgeStage, f as formatCedula, r as renderValue } from './utils_CdDBA7zL.mjs';
/* empty css                                */
import { parse } from 'cookie';
import jwt from 'jsonwebtoken';
import { U as UserRepository } from './user-repository_C06Cq5l3.mjs';
import { c as connectDB } from './mongodb_Bx9AnUPZ.mjs';
import '../renderers.mjs';

async function updateDesaparecido(id, data) {
...
async function acceptDesaparecido(id) {
...
async function rejectDesaparecido(id) {
...
async function fetchDesaparecidoDetails(id) {
  const response = await fetch(`/api/desaparecidos/${id}`);
  if (!response.ok) {
...
const ExpandedRowPanel = React__default.lazy(() => import('./ExpandedRowPanel_q5gcMVA-.mjs'));
...
function PanelTable({
  ...
  const handleSave = useCallback(async (e) => {
    ...
    try {
      ...
      await updateDesaparecido(editedData._id, { ...dataToUpdate, extranjero: dataToUpdate.extranjero || "V" });
      for (const imageUrl of imagesToDelete) {
        await deleteImageFromR2(imageUrl);
      }
      toast({ title: "Éxito", description: "Información actualizada correctamente" });
      setLocalData(
        (prevData) => prevData.map((item) => item._id === editedData._id ? { ...item, ...dataToUpdate } : item)
      );
      setEditingId(null);
      setEditedData(null);
      setErrors({});
      ...
      if (name === "extranjero") {
        return /* @__PURE__ */ jsxs(Select, { name, onValueChange: (value2) => handleSelectChange(name, value2), value: editedData?.[name], children: [
          ...
          /* @__PURE__ */ jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsx(SelectItem, { value: "V", children: "V" }),
            /* @__PURE__ */ jsx(SelectItem, { value: "E", children: "E" })
          ] })
        ] });
      } else if (name === "estado") {
        return /* @__PURE__ */ jsxs(Select, { name, onValueChange: (value2) => handleSelectChange(name, value2), value: editedData?.[name], children: [
  ...
  return /* @__PURE__ */ jsx("div", { className: "overflow-x-auto rounded-lg shadow dark:bg-gray-900", children: /* @__PURE__ */ jsxs(Table, { children: [
    ...
    /* @__PURE__ */ jsx(TableBody, { children: filteredData.map((item, index) => {
      const key = item._id && typeof item._id === "string" && item._id.trim() !== "" ? item._id : `row-fallback-${index}`;
      ...
      return /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
        /* @__PURE__ */ jsxs(
          motion.tr,
          {
            ...
            className: `cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 ${editingId === item._id ? "bg-blue-50 dark:bg-gray-900" : ""} dark:text-gray-200`,
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(TableCell, { className: "text-center", children: editingId === item._id ? /* @__PURE__ */ jsxs(Fragment, { children: [
                ...
                item._id && item.estado_registro === "pendiente" && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx(
                    Button,
                    {
                      onClick: (e) => {
                        e.stopPropagation();
                        if (item._id) onAccept(item._id);
                      },
        ...
        /* @__PURE__ */ jsx(AnimatePresence, { children: expandedRow === item._id && /* @__PURE__ */ jsx(
          motion.tr,
          {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-8", children: [
      ...
      /* @__PURE__ */ jsx(TableBody, { children: requests.map((request) => {
        ...
        return /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            request.desaparecido_id?.imagen && /* @__PURE__ */ jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "font-medium", children: request.desaparecido_id?.nombre }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-500", children: request.desaparecido_id?.cedula })
            ] })
          ] }) }),
    ...
    /* @__PURE__ */ jsx(Dialog, { open: actionDialogOpen, onOpenChange: setActionDialogOpen, children: /* @__PURE__ */ jsxs(DialogContent, { children: [
      /* @__PURE__ */ jsxs(DialogHeader, { children: [
        ...
        /* @__PURE__ */ jsx(DialogDescription, { children: actionType === "approve" ? "Al aprobar, el registro del desaparecido será eliminado permanentemente." : "La solicitud será rechazada y el registro permanecerá visible." })
      ] }),
      selectedRequest && /* @__PURE__ */ jsxs("div", { className: "py-4", children: [
        ...
        /* @__PURE__ */ jsxs("p", { children: [
          ...
          " ",
          selectedRequest.desaparecido_id?.nombre
        ] }),
        /* @__PURE__ */ jsxs("p", { children: [
...
const $$PanelAdmin = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Panel de administrador" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div style="height: 60px;"></div> ${renderComponent($$result2, "PanelEngine", PanelEngine, { "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/Users/arang/Desktop/Importante/NoMasSecuestros/src/components/PanelEngine.tsx", "client:component-export": "default" })} <div style="height: 60px;"></div> ` })}`;
}, "C:/Users/arang/Desktop/Importante/NoMasSecuestros/src/pages/panel-admin.astro", void 0);
const $$file = "C:/Users/arang/Desktop/Importante/NoMasSecuestros/src/pages/panel-admin.astro";
